...
public class State_MoveToLocation : BaseState
{
    ...
    public override void State_Enter()
    {
        ...
        // This logic below would not be present if we had a navigation + pathfinding system.
        // If we had navigation + pathfinding this function would instead tell the navigation system to set a new destination
    ...
    public void CanTransition_ToIdle(TransitionResponse response)
    {
        ...
        response.CanTransition = Vector3.Distance(transform.position, TargetLocation) <= LocationReachedThreshold;
    }    
}
